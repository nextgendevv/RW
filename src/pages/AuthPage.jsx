...
export default function AuthPage({ defaultRef }) {
  // If opened via a referral link, default to Sign Up tab and pre-fill the code
  const [tab, setTab] = useState(defaultRef ? 'signup' : 'signin');
    ...
    <div className="auth-bg">
      <div className="auth-card">
        ...
        <div className="auth-brand">
          ...
          <p className="brand-tagline">Your secure green space</p>
        </div>
